    ...
    <div id="tabs">
         <div class="container">
            <ul>
                      ...
                      <li><a href="#" class="current" ><span>Master Jabatan</span></a></li>
...
<!-- CONTENT START -->
    ...
    <!--  TITLE START  --> 
    <div class="grid_9">
    <h1 class="dashboard">Data Jabatan</h1>
    </div>
    <!--RIGHT TEXT/CALENDAR-->
    ...
    <!-- FIRST SORTABLE COLUMN START -->
      ...
      <!--THIS IS A PORTLET-->
		<div class="portlet">
            <table>
				<tr>
		<td hidden>ID Jabatan</td>
		<td hidden>:</td>
		<td hidden colspan="2"><input type="text" id="idjab"></td>
	</tr>
	<tr>
		<td height="30px" width="100px" style="vertical-align:middle;">Nama jabatan</td>
		<td height="30px" width="20px" style="vertical-align:middle;">:</td>
		<td height="30px" style="vertical-align:middle;" colspan="2"><input type="text" id="namajab"></td>
	</tr>
	<tr>
		<td></td>
		<td></td>
		<td><input type="button" id="simpanbag" name="simpanbag" value="Buat Baru" onclick="simpanjab();" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" id="ubahbag" name="ubahbag" value="Ubah" onclick="ubahjab();" disabled ></td>
	</tr>
			</table>
        </div>      
      <!--THIS IS A PORTLET-->
